...
import Exceptions.InvalidDepartmentNumberException;
import Exceptions.InvalidSalaryNumberException;
...
public class Employee {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(firstName, middleName, lastName, departmentNumber, salary, id);
    }
